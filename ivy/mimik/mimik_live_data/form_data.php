...
$The_Form_ID = $The_View_Parameters['id'];
...
?>
		...
		if ($The_Indication_To_Be_Text_Only) :
			if ($The_Menu_ID != '') :
				$The_Include = $THE_BASE_URL . '/mimik/mimik_live_data/view.php?id=138&page_id=' . $The_View_Parameters['record_id'] . '&record_id=' . $The_Menu_ID . '&force_menu=1';
			// otherwise, use the "default" menu for this landing page
				...
				$The_Include = $THE_BASE_URL . '/mimik/mimik_live_data/view.php?id=138&page_id=' . $The_View_Parameters['record_id'] . '&page_type=standalone&record_id=' . $The_Standalone_Menu_Association_ID;
			endif;
			include($The_Include);
		endif;
		?>
