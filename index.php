...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
			...
			<section class="main-section" id="development" name="development">
				...
				<article class="links-subsection" id="links" name="links">
					...
					<ul>
						...
						<li><a target="_blank" href="http://khameleon.org/work/sites/hslc">Health Sciences Library Consortium</a> &ndash; CSS build, most of a Drupal theme (the latter was handed off to the Commonwealth of Pennsylvania's in-house developers due to a last-minute change of plans on their end. As far as I know, the project is still in bureaucratic purgatory, hence the layout's being hosted on my own web space.)</li>
		...
		<script async src="//code.jquery.com/jquery.min.js"></script>
